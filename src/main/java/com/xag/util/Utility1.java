...
public class Utility1 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Utility1.class);
    ...
    public static void byteStream(String input_filename, String output_filename) throws IOException {
        ...
        try {
            ...
            logger.info("ByteStream file coping success.");
    ...
    public static void characterStream(String input_filename, String output_filename) throws IOException {
        ...
        try {
            ...
            logger.info("CharacterStream file coping success.");
    ...
    public static void writeStringToFile(String text, String filename) {
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(filename, true))) {
            ...
            logger.error("PatientDetail detail saving failed.");
        }
    }
    ...
    public static String readFile(String filename) {
        ...
        if (filename.equals("0")) {
            ...
            try (BufferedReader bufferedReader = new BufferedReader(new FileReader(filename))) {
                ...
                logger.error("The requested record could not be found.");
            }
        }
        return output;
    }
